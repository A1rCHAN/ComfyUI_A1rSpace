...
app.registerExtension({
    name: "A1rSpace.CustomSlider",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name !== "A1r Custom Slider") return;
        ...
        nodeType.prototype.onNodeCreated = function() {
            ...
            const bind = () => {
                ...
                wSwitch.callback = (v) => {
                    ...
                    this.properties.decimals = v >= 1 ? 2 : 0;
        ...
        nodeType.prototype.onAdded = function() {
            ...
            // 更新输出类型
            this.outputs[0].type = (this.properties.decimals >= 1) ? "FLOAT" : "INT";
        ...
        nodeType.prototype.onPropertyChanged = function(propName) {
            ...
            // 当小数位变更时切断不兼容的连接
            if ((this.properties.decimals >= 1 && this.outputs[0].type !== "FLOAT") || 
            ...
            // 更新类型切换widget
            this.widgets[2].value = (this.properties.decimals >= 1) ? 1 : 0;
